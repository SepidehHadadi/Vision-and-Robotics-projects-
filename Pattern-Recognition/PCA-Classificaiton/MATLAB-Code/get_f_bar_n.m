function [ f_bar ] = get_f_bar(files)

    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % Step 1: 
    % initialize f_bar to the first image that will be trained
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    f_bar = load(['images\train_images\' files(1).name]);
    ...
    while(counter < 100)
        ...
        for i = 1: length(files)
          % x= ['images\train_images\' files(i).name]
            fi      = load(['images\train_images\' files(i).name]);
